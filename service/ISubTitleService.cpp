...
enum {
    ...
    SUB_NEXT                = IBinder::FIRST_CALL_TRANSACTION + 4,
    SUB_PREVIOUS            = IBinder::FIRST_CALL_TRANSACTION + 5,
    SUB_SHOW_SUB            = IBinder::FIRST_CALL_TRANSACTION + 6,
    SUB_OPTION	            = IBinder::FIRST_CALL_TRANSACTION + 7,
    SUB_GET_TYPE            = IBinder::FIRST_CALL_TRANSACTION + 8,
    SUB_GET_TYPE_STR        = IBinder::FIRST_CALL_TRANSACTION + 9,
    SUB_GET_TYPE_DETIAL     = IBinder::FIRST_CALL_TRANSACTION + 10,
    SUB_SET_TEXT_COLOR      = IBinder::FIRST_CALL_TRANSACTION + 11,
    SUB_SET_TEXT_SIZE       = IBinder::FIRST_CALL_TRANSACTION + 12,
    SUB_SET_GRAVITY         = IBinder::FIRST_CALL_TRANSACTION + 13,
    SUB_SET_TEXT_STYLE      = IBinder::FIRST_CALL_TRANSACTION + 14,
    SUB_SET_POS_HEIGHT      = IBinder::FIRST_CALL_TRANSACTION + 15,
    SUB_SET_IMG_RATIO       = IBinder::FIRST_CALL_TRANSACTION + 16,
    SUB_CLEAR               = IBinder::FIRST_CALL_TRANSACTION + 17,
    SUB_RESET_FOR_SEEK      = IBinder::FIRST_CALL_TRANSACTION + 18,
    SUB_HIDE                = IBinder::FIRST_CALL_TRANSACTION + 19,
    SUB_DISPLAY             = IBinder::FIRST_CALL_TRANSACTION + 20,
    SUB_GET_CUR_NAME        = IBinder::FIRST_CALL_TRANSACTION + 21,
    SUB_GET_NAME            = IBinder::FIRST_CALL_TRANSACTION + 22,
    SUB_GET_LANGUAGE        = IBinder::FIRST_CALL_TRANSACTION + 23,
    SUB_LOAD                = IBinder::FIRST_CALL_TRANSACTION + 24,
};
